$(function () {
    ...
    $.ajax({
      ...
      method: "POST",
      success: (result) => {
        $.each(result.routesTripsArray, (index, trips) => {
            $("#addTrip").append("<div class='my-2 h4 google-font'>"+result.routesArray[index].SourceCity+" - "+ result.routesArray[index].DestinationCity+"</div>");
